...
import lombok.AllArgsConstructor;
    ...
    public class MessageController {
       ...
       public String saveMessage(@PathVariable("roomId") Integer roomId, @ModelAttribute MessageForm messageForm, @AuthenticationPrincipal CustomUserDetail currentUser) {
